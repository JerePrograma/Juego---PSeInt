				...
				SiNo
					...
					SiNo
						...
						SiNo
							...
							danioAlEnemigo <- fuerzaPersonaje * redon(((valorDadoPersonaje - 1) * 20 / 100));
						FinSi
					FinSi
				FinSi
						...
						SiNo
							...
							SiNo
								...
								SiNo
									...
									danioRecibidoEnemigo <- redon((valorDadoEnemigo - 1) * 20 / 100);
								FinSi
								...
								SiNo
									...
									SiNo
										...
										danioAlEnemigo <- redon(danioAlEnemigo * ((100 - danioRecibidoEnemigo) / 100));
										vidaEnemigo <- vidaEnemigo - danioAlEnemigo;
										Escribir "Le hiciste ", danioAlEnemigo, " de daño al enemigo";
									FinSi
								FinSi
